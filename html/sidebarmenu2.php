<ul class="nav nav-list">
    <?php
        ...
        ?>
        <li class="<?php if ($urlpar == 'dashboard') { echo "active"; } ?>">
    ...
    ?>
    <!-- <li class="<?php if ($urlpar == 'companyfullview' || $urlpar == 'companysearch' || $urlpar == 'individualsearch' || $urlpar == 'individualfullview') { echo "active"; } ?>">
            ...
            <ul class="submenu">
                <li class="<?php if ($urlpar == 'companysearch') { echo "active"; } ?>">
    ...
    ?>
        <li class="<?php if ($urlpar == 'awards' || $urlpar == 'levels' || $urlpar == 'faculty' || $urlpar == 'specialization' || $urlpar == 'institution' || $urlpar == 'course' || $urlpar == 'educationdata' || $urlpar == 'viewinstitution' || $urlpar == 'viewinstitutionplans' || $urlpar == 'companyregcheck' || $urlpar == 'creditcheck' || $urlpar == 'customerrefcheck' || $urlpar == 'globalwatchlist' || $urlpar == 'proffessionalmembership' || $urlpar == 'companymodules' || $urlpar == 'companydataentry' || $urlpar == 'residency' || $urlpar == 'shareholdingcheck' || $urlpar == 'identitycheck' || $urlpar == 'passportcheck' || $urlpar == 'drivinglicensecheck' || $urlpar == 'educationcheck' || $urlpar == 'socialmedia' || $urlpar == 'individualmodules' || $urlpar == 'individualdataentry' || $urlpar == 'watchlistindividualcheck' || $urlpar == 'criminalcheck' || $urlpar == 'psvlicensecheck' || $urlpar == 'proffmemberverificationcheck' || $urlpar == 'taxcompliancecheck' || $urlpar == 'fingerprintcheck' || $urlpar == 'socialmediacheck' || $urlpar == 'residencycheck' || $urlpar == 'employementcheck' || $urlpar == 'watchlistcompanycheck' || $urlpar == 'profflicenseverificationcheck' || $urlpar == 'businesslicensecheck' || $urlpar == 'sitevisitcheck') { echo "active"; } ?>">
            ...
            ?>
                ...
                <ul class="submenu">
                    <li class="<?php if ($urlpar == 'companymodules') { echo "active"; } ?>">
                    ...
                    <li class="<?php if ($urlpar == 'individualmodules') { echo "active"; } ?>">
                ...
                <ul class="submenu">
                    <li class="<?php if ($urlpar == 'awards' || $urlpar == 'levels' || $urlpar == 'faculty' || $urlpar == 'specialization' || $urlpar == 'institution' || $urlpar == 'course' || $urlpar == 'educationdata' || $urlpar == 'viewinstitution' || $urlpar == 'viewinstitutionplans' || $urlpar == 'viewinstitutioncourses' || $urlpar == 'addinstitutioncourse' || $urlpar == 'addinstitutionplans') { echo "active"; } ?>">
                        <a href="#" class="dropdown-toggle">
                            <i class="menu-icon fa fa-caret-right"></i>
                            Education
                            <b class="arrow fa fa-angle-down"></b> </a>
    ...
    if (in_array('VIEW_CLIENTS', $roledata)) {
    ?>
        <li class="<?php if ($urlpar == 'companys' || $urlpar == 'clientsusers') { echo "active"; } ?>">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-user"></i>
                <span class="menu-text">
                    Peleza Clients </span>
    ...
    ?>
        <li class="<?php if ($urlpar == 'ed_searches' || $urlpar == 'ed_requests') { echo "active"; } ?>">
            <a href="#" class="dropdown-toggle">
    ...
    ?>
        <li class="<?php if ($urlpar == 'education' || $urlpar == 'psmt_requests_quotes' || $urlpar == 'psmt') { echo "active"; } ?>">
            <a href="#" class="dropdown-toggle">
    ...
    ?>
        <li class="<?php if ($urlpar == 'modules' || $urlpar == 'currency' || $urlpar == 'plans' || $urlpar == 'industry' || $urlpar == 'countries' || $urlpar == 'dataset') { echo "active"; } ?>">
            <a href="#" class="dropdown-toggle">
        ...
        ?>
        <li class="<?php if ($urlpar == 'datafiles' || $urlpar == 'educationupload' || $urlpar == 'viewfiledata' || $urlpar == 'datauploader' || $urlpar == 'staginguploader' || $urlpar == 'idupload') { echo "active"; } ?>">
            <a href="#" class="dropdown-toggle">

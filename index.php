...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "forgotpassword")) {
    ...
    $mail->setFrom('support@edcheckafrica.com', 'Peleza Admin');

    $mail->addAddress($_POST['USR_USERNAME']);
  ...
  <tbody>
    <tr valign="top">
      <td>Hi, <br />
          <br />
    <div align="center">    <em><strong>FORGOT YOUR PASSWORD</strong></em></div></td>
    </tr>
  </tbody>
</table>
<table width="530" cellspacing="0" cellpadding="0" border="0" align="center">
  <tbody>
    <tr valign="top">
      <td><br />
        Your One time password is: <strong>' . $_POST['USR_PIN'] . '</strong> click the button below to login and change password.<br />
        <br />
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    ...
    <tr>
        <td style="background-color: #c2d247;border-color: #c2d247;border: 2px solid #c2d247;padding: 10px;text-align: center;">
            <a style="display: block;color: #094156;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="https://pidva.africa" target="_blank">
...
<table width="530" cellspacing="0" cellpadding="0" border="0" align="center">
  <tbody>
    <tr valign="top">
      <td><br />
        For your security, the registration confimration link expires after 48 hours. After that, please contact your <a href="www.peleza.com" target="_blank">administrator</a> for confirmation of your account. <br />
        <br />  You have received this mandatory email service  announcement to update you about important changes to your EdCheck product or account.<br /><br />
      </td>
    </tr>
    <tr>
       <td width="100%">Sincerely,<br />
        <strong>Peleza Admin</strong> <br />
        Administrator <br />
        support@peleza.com<br />
        Westlands<br /><br />
        
		copyright©2018.All rights reserved.Peleza International.<br />
          <br />
      </td>
    </tr>
  </tbody>
    ...
    $mail->Subject = 'Do Not Reply: ACCT-PEL-PWD-RESET';
    ...
    if (!$mail->send()) {
        ...
        $updateSQL = sprintf(
            "UPDATE pel_users SET USR_STATUS='33', USR_PASSWORD=%s, USR_PIN=%s WHERE USR_STATUS = '11' and USR_STAFF_ID=%s and USR_USERNAME=%s",
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="login-container">
                        <div class="center">
                            <h1>
                                <img src="assets/images/PelezaLogo.png" alt="Peleza Logo">
                            </h1>
                                    ...
                                    <div class="widget-main">
                                        ...
                                        if (isset($_POST['username'])) {
                                            ...
                                            WHERE USR_USERNAME=%s AND USR_PASSWORD=%s AND USR_STAFF_ID=%s",
                                                ...
                                                GetSQLValueString($staffnumber, "text")
                                            );
                                            ...
                                            if ($loginFoundUser) {
                                                ...
                                                while ($row = mysqli_fetch_array($LoginRS)) {
                                                    ...
                                                    if ($row['USR_STATUS'] == '11') {
                                                        ...
                                                        $_SESSION['MM_USR_PROFILE_NAME'] = $row['USR_PROFILE_NAME'];
                                                        $_SESSION['MM_USR_PHOTO'] = $row['USR_PHOTO'];
                                                        ...
                                                        $updateSQL = sprintf(
                                                            "UPDATE pel_users SET USR_LAST_LOGIN=%s, USR_PIN_STATUS='0' WHERE USR_STATUS = '11' and USR_STAFF_ID=%s and USR_USERNAME=%s",
                                                            GetSQLValueString(date('d-m-Y H:m:s'), "text"),
                                                            GetSQLValueString($row['USR_STAFF_ID'], "text"),
                                                            GetSQLValueString($loginUsername, "text")
                                                        );
                                                    ...
                                                    if ($row['USR_STATUS'] == '00' || $row['USR_STATUS'] == '22') {
                                        ?>
                                            ...
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right"><span id="sprytextfield1">
                                                            <input id="staffnumber" name="staffnumber" type="text" class="form-control" placeholder="Staff Number" autofocus />
                                                            <span class="textfieldRequiredMsg">*</span></span><i class="ace-icon fa fa-user"></i>
                                                    </span>
                                                </label>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right"><span id="sprytextfield2">
                                                            <input id="username" name="username" type="text" class="form-control" placeholder="Username" />
                                                            <span class="textfieldRequiredMsg">*</span></span><i class="ace-icon fa fa-user"></i></span>
                                                </label>

                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right"><span id="sprytextfield3">
                                                            <input id="password" name="password" type="password" class="form-control" placeholder="Password" />
                                                            <span class="textfieldRequiredMsg">*</span></span><i class="ace-icon fa fa-lock"></i></span>
                                                </label>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        ...
                                        <form method="POST" action="<?php echo $editFormAction; ?>" name="forgotpassword">
                                            ...
                                            <input id="USR_PIN" name="USR_PIN" type="hidden" class="form-control" value="<?php echo "" . GeraHash2(6) . "" . date('ms'); ?>" />
                                            <fieldset>
                                                <label class="block clearfix">
